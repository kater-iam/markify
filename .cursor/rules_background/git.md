...
1. GitFlow + PR
  ...
  - develop/mainブランチへの直接コミット禁止の理由：
    - コードの品質管理：すべての変更をPRでレビューすることで品質を担保
    - 履歴の整理：機能単位でブランチを分けることで、変更の追跡が容易に
    - 競合の防止：複数の開発者が同時に作業する際の競合リスクを低減
    - リリース管理：mainブランチを常にデプロイ可能な状態に保つ
